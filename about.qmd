...
|------------|------------|------------|------------|------------|------------|
| Wrote North Meck Needs Assessment Report and developed Community Research Library Guide | Continued North Meck data collection through focus groups & a survey | Finalized the Needs Assessment Report and developed a North Meck Data Dashboard | Collaborated with CREED and developed the E(race)ing Inequities Dashboard | Created Open Davidson website to provide accessible archives of The Davidsonian | (our project overview) |
