...
|------------|------------|------------|------------|------------|------------|
| Wrote North Meck Needs Assessment and developed the Community Research Library Guide | Continued data collection through focus groups & a survey on areas identified in Needs Assessment | Completed the North Meck Data Dashboard | Collaborated with CREED and developed the E(race)ing Inequities Dashboard | Created Open Davidson website to provide accessible archives of The Davidsonian | (our project overview) |
